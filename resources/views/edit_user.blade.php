...
<body class="flex items-center justify-center h-screen" style="background: linear-gradient(to bottom right, #d1c6f3, #ffb6c1);">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-md text-center w-full">
        ...
        <form action="{{ route('users.update', $user['id']) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" id="nama" name="nama" placeholder="Masukkan nama" value="{{ old('nama', $user->nama) }}" class="w-full mt-1 px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
            ...
            <div>
                ...
                <input type="text" id="npm" name="npm" placeholder="Masukkan NPM" value="{{ old('npm', $user->npm) }}" class="w-full mt-1 px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
    ...
    @endforeach
            ...
            <div class="form-group">
                ...
                <input type="file" id="foto" name="foto" class="form-control" accept="image/*" class="w-full mt-1 px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
                @if($user->foto)
